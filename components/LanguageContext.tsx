...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'public_holidays_hint': '中国自 2025 年起法定节假日默认 13 天',
    ...
    'share_custom_made': '由 工作价值计算器 生成',
  ...
  en: {
    ...
    'public_holidays_hint': 'For China, the default is 13 statutory holidays from 2025 onward.',
    ...
    'share_custom_made': 'Generated by 工作价值计算器',
  ...
  ja: {
    ...
    'annual_leave': '年次有給休暇',
    'public_holidays': '祝日数',
    'public_holidays_hint': '中国では 2025 年以降、法定祝日はデフォルトで 13 日です。',
